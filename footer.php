        ...
        <div class="footer-wrapper">
          ...
          <div class="footer__nav footer__categories">
            ...
            <ul class="footer__list">
              ...
              <li class="footer__item"><a href="#" class="footer__item-link">Activities</a></li>
              <li class="footer__item"><a href="#" class="footer__item-link">Spa Packages</a></li>
              <li class="footer__item">
                <a href="#" class="footer__item-link">Hotel Day Packages</a>
              </li>
              <li class="footer__item"><a href="#" class="footer__item-link">Restaurants</a></li>
              <li class="footer__item"><a href="#" class="footer__item-link">Fitness</a></li>
              <li class="footer__item"><a href="#" class="footer__item-link">Rodrigues</a></li>
            </ul>
          </div>
          <div class="footer__nav footer__additional">
            <h3 class="footer__title">Additional information</h3>
            <ul class="footer__list">
              <li class="footer__item"><a href="#" class="footer__item-link">About Us </a></li>
              <li class="footer__item"><a href="#" class="footer__item-link">Contact Us </a></li>
              <li class="footer__item">
          ...
          <div class="footer__contact-details">
            <h3 class="footer__title footer__title--mt-contact">Contact Details</h3>
